...
from .models import Determina

class DeterminaDetailView(ActDetailView):
    model = Determina

    def get_object(self):

        user = self.request.user
        act = super(DeterminaDetailView, self).get_object()
...
#        print "person: %s" % person
    ...
    def dispatch(self, request, *args, **kwargs):
        try:
            return super(DeterminaDetailView, self).dispatch(request, *args, **kwargs)
