...
SITE_INFO = {
    'main_city': u'CORATO - Informazione libera',
    'site_version': u'Beta',
    'main_city_logo': 'img/city-logo/city-logo.png',
    'main_city_website': 'http://www.opencorato.org',
}
...
SUIT_CONFIG = {
    ...
    'MENU_EXCLUDE': ('auth.group',),
     'MENU': (
        ...
        {'app': 'oc_determine', 'label': 'Determine Dirigenti', 'icon':'icon-book', 'models': ('determina')},
